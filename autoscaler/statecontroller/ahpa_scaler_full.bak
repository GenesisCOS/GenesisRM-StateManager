...
class AHPAScaler(Scaler):
    def __init__(self, cfg, logger: Logger):    
        ...
        self.cpu_scale_rate = cfg.scaler.ahpa_scaler.cpu_scale_rate
    ...
    def pre_start(self):
        self.__logger.info('AHPA Scaler preStart ...')
    ...
    def start(self):
        ...
        while True:
            ...
            for service in self.__services:
                ...
                _max = max(lt_ret, st_ret, 1)
                _max = min(_max, max_conf)
                
                self.__logger.info(f'lt_ret: {lt_ret}, st_ret: {st_ret}, _max: {_max} - {service}')
            ...
            if control_loop_time < 60:
                time.sleep(60 - control_loop_time)
